...
let bashstring="sudo chmod a+rwx " + dir + "/task*.sh\n"
...
for(let i=0; i< tasks.length; i++){
  ...
  const outstr = "echo \"sudo node " + dir + "/src/betfairproxy/marketts --conf=" + dir + "/testconfig.json --marketid=" + marketid + " --iterations=" + iterations + " --delay=" + delay + "\" > " + dir + "/task" + i + ".sh"
